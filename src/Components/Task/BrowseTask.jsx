    ...
    <div className="grid grid-cols-1 md:grid-cols-3 w-11/12 mx-auto gap-5 my-10">
      {tasks.map((task) => (
        <div key={task._id} className="">
          <div className="card bg-[#202124] text-primary-content w-[100%] px-[2%] mx-auto shadow-[0_0px_50px_rgba(255,255,255,0.5)]">
            <div className="card-body">
              <img className="w-[100%] mx-auto h-[230px]" src="public/undraw_accept-task_vzpn.png" alt="" />
